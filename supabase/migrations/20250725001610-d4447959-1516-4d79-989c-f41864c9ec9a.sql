...
CREATE INDEX IF NOT EXISTS idx_articles_blocks_gin ON public.articles USING GIN(blocks);
...
DROP TRIGGER IF EXISTS save_article_version_trigger ON public.articles;
